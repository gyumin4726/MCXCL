...
def visualize_fluence_map(array, output_dir='.', material_name='Water'):
    """Fluence Map을 시각화"""
...
def analyze_optical_properties(array, metadata, material_name='Water'):
    """광학 특성 분석"""
...
def main():
    ...
    try:
        ...
        # 시각화
        visualize_fluence_map(array, material_name='Water')
        
        # 분석
        analyze_optical_properties(array, metadata, material_name='Water')
        
        print("\n✅ 모든 작업이 완료되었습니다!")
        print("생성된 파일:")
        print("- water_fluence_map.png (시간 게이트별 시각화)")
